...
import { VectorCalculator } from "../lib/components/VectorCalculator";
import { v4 as uuidv4 } from "uuid";

class VectorCalculatorDemo extends Component {
    constructor(props) {
        super(props);
            ...
            <VectorCalculator
                ...
                vectors={[
                    ...
                    },
                    {
                        name: "RGIP",
                        description:
                            "Gas In Place (liquid+gas phase), region 1",
                        children: [
                            {
                                name: "1",
                            },
                    ...
                    },
                    {
                        name: "ROIP",
                        description:
                            "Oil In Place (liquid+gas phase), region 1",
                        children: [
                            {
                                name: "1",
                            },
...
export default VectorCalculatorDemo;
