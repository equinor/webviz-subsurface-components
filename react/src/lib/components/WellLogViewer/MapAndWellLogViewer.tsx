    ...
    onTrackScroll(): void {
        ...
        if (iTrack >= 0) {
            ...
            if (track) {
                ...
                if (templatePlot) {
                    const wells_layer = (this.props.layers as Record<string, unknown>[])?.find(
                        (item: Record<string, unknown>) => item["@@type"] === "WellsLayer"
                    );
                    if (
                        wells_layer &&
                        ...
                        this.setState({ layers: layers as Record<string, unknown>[] });
