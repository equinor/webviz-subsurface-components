...
const ColorLegend: React.FC<colorLegendProps> = ({data}: colorLegendProps) => {
    React.useEffect(() => {legendDemo();}, [data]);
    const legendDemo = () => {
        /* Discrete Legend */
        const itemName:any = []
        const itemColor:any = []
        ...
        let verticalLegend = colorLegend(itemColor).labelFormat("none").cellPadding(5).orientation("vertical")
            .units("Discrete Legend").cellWidth(25).cellHeight(18).inputScale(sampleOrdinal).cellStepping(10);
